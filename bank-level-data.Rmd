...
# data_periods <- c(data_periods,"03312023","06302023","09302023","1231") # replace 12312013 with post SVB call reports when available
...
for (dp in data_periods) {
  ...
  call_2 <- dbGetQuery(con_call,paste0("select 
                                        ...
                                        RIAD4508+RIAD0093+RIADHK03+RIADHK04 int_exp_deposits,
...
bank_call_st <-  call[date=="2023-12-31",c("IDRSSD","assets_total","loans_total","core_deposits","time_deposits","deposits_domestic_uninsured","deposits_domestic_insured","nim","roe","deposits_domestic")]
